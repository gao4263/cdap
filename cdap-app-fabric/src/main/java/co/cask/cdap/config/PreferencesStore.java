...
public class PreferencesStore {
  ...
  private Map<String, String> getConfigProperties(String namespace, EntityId entityId) {
    return Transactionals.execute(transactional, context -> {
      Map<String, String> value = new HashMap<>();
      try {
        Config config = ConfigDataset.get(context, datasetFramework).get(namespace, PREFERENCES_CONFIG_TYPE,
                                                                         entityId.toString());
  ...
  private void setConfig(String namespace, EntityId entityId,
                         Map<String, String> propertyMap) throws NotFoundException, ProfileConflictException {
    Config config = new Config(entityId.toString(), propertyMap);
    validateAndSetPreferences(namespace, entityId, config);
  }

  private void deleteConfig(String namespace, EntityId entityId) {
    boolean profileExists = Transactionals.execute(transactional, context -> {
      try {
        ...
        boolean exist = configDataset.get(namespace, PREFERENCES_CONFIG_TYPE, entityId.toString())
                          .getProperties().containsKey(SystemArguments.PROFILE_NAME);
        configDataset.delete(namespace, PREFERENCES_CONFIG_TYPE, entityId.toString());
        return exist;
      } catch (ConfigNotFoundException e) {
        return false;
      }
  ...
  public Map<String, String> getProperties() {
    return getConfigProperties(EMPTY_NAMESPACE, new InstanceId(EMPTY_NAMESPACE));
  }

  public Map<String, String> getProperties(String namespace) {
    return getConfigProperties(namespace, new NamespaceId(namespace));
  }

  public Map<String, String> getProperties(String namespace, String appId) {
    return getConfigProperties(namespace, new ApplicationId(namespace, appId));
  }

  public Map<String, String> getProperties(String namespace, String appId, String programType, String programId) {
    return getConfigProperties(namespace, new ProgramId(namespace, appId,
  ...
  public void setProperties(Map<String, String> propMap) throws NotFoundException, ProfileConflictException {
    setConfig(EMPTY_NAMESPACE, new InstanceId(EMPTY_NAMESPACE), propMap);
  }

  public void setProperties(String namespace,
                            Map<String, String> propMap) throws NotFoundException, ProfileConflictException {
    setConfig(namespace, new NamespaceId(namespace), propMap);
  }
  ...
  public void setProperties(String namespace, String appId, Map<String, String> propMap)
    ...
    setConfig(namespace, new ApplicationId(namespace, appId), propMap);
  }

  public void setProperties(String namespace, String appId, String programType, String programId,
                            Map<String, String> propMap) throws NotFoundException, ProfileConflictException {
    setConfig(namespace, new ProgramId(namespace, appId, ProgramType.valueOfCategoryName(programType),
                                       programId), propMap);
  }

  public void deleteProperties() {
    deleteConfig(EMPTY_NAMESPACE, new InstanceId(EMPTY_NAMESPACE));
  }

  public void deleteProperties(String namespace) {
    deleteConfig(namespace, new NamespaceId(namespace));
  }

  public void deleteProperties(String namespace, String appId) {
    deleteConfig(namespace, new ApplicationId(namespace, appId));
  }

  public void deleteProperties(String namespace, String appId, String programType, String programId) {
    deleteConfig(namespace, new ProgramId(namespace, appId, ProgramType.valueOfCategoryName(programType), programId));
  }
